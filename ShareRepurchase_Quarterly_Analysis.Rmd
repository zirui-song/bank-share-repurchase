...
### Dividend
reg1_div <- glm(Dividend_Dummy ~ Lag_Institutional_Ownership + Total_Assets + Tier1Capital_Ratio + factor(yearq), family = binomial(link = "probit"), data = data_inst)
summary(reg1_div)
# Logit
reg1_1_div <- glm(Dividend_Dummy ~ Lag_Institutional_Ownership + Total_Assets + Tier1Capital_Ratio + factor(yearq), family = binomial(link = "logit"), data = data_inst)
summary(reg1_1_div)
```
```{r}
...
cl_ccov_mat_check1 <- vcovCL(reg1_quintile, type = "HC1", cluster = data_inst$yearq)
...
cl_ccov_mat_check2 <- vcovCL(reg1_1_quintile, type = "HC1", cluster = data_inst$yearq)
