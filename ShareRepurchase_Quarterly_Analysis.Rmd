...
data <- compustat %>%
  dplyr::select(gvkey, tic, fyearq, fqtr, atq, capr1q, niq, ibq, req, dvpy, dvp, dvy, tstkq, tstk, prstkcy, sstky, prstkc, sstk, naicsh, conm, fic)
...
data <- data %>%
  arrange(tic, fyearq, fqtr) %>% 
  select(tic, fyearq, fqtr, tstkq, tstk, prstkcy, sstky, prstkcy1, sstky1, repurchase, dvpy, dvp, dvy, dividend, everything())
